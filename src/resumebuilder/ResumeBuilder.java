...
class ResumeBuilder extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (s.equals("GENERATE")) {
            ...
            if (name.equals("") || fathername.equals("") || city.equals("") ||
                ...
                f = new JFrame();
                JOptionPane.showMessageDialog(f, "Resume Generated Successfully");
                ...
                String q="insert into resumedetails(name,gender,fathername,password,city,email,skills,college,degree,linkedin,github,contact,experience) values('"+name+"','"+gender+"','"+fathername+"','"+password1+"','"+city+"','"+email+"','"+uskills+"','"+ucollege+"','"+udegree+"','"+ulinkdln+"','"+ugithub+"','"+ucontact+"','"+uexperience+"')";
    ...
    public static void main(String args[]) {
        ResumeBuilder r = new ResumeBuilder();
